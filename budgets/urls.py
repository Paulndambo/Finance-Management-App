...
from budgets.views import budgets, budget_details, new_budget, edit_budget, delete_budget, lock_budget, unlock_budget, new_budget_allocation, edit_budget_allocation, delete_budget_allocation
...
urlpatterns = [
    ...
    path("lock-budget/", lock_budget, name="lock-budget"),
    path("unlock-budget/", unlock_budget, name="unlock-budget"),
